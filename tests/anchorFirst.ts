...
const programId = new anchor.web3.PublicKey("nAAoDaKw9XQF9QgpyT6RyTvHPhdwd1fqkPZTM8LiW7H");
...
describe("anchorFirst", () => {
  ...
  it("Is initialized!", async () => {
    ...
    let token_airdrop= await con.requestAirdrop(User_Wallet.publicKey, 100000000000);
  ...
  console.log("print");
  transaction.add(await program.methods.initialize(user_bump)
  .accounts({
